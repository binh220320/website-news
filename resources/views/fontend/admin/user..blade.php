...
<body class="dark-edition">
    <div class="wrapper ">
        <div class="sidebar" data-color="purple" data-background-color="black" data-image="../assets/img/sidebar-2.jpg">
            ...
            <div class="logo"><a href="https://www.facebook.com/n.dongnobi" class="simple-text logo-normal">
        ADMIN
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item" href="javascript:void(0)">Helo baby</a>
                                    <a class="dropdown-item" href="javascript:void(0)">Không có thông báo đâu</a>
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Permisson</label>
                                                    <input type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card card-profile">
                                <div class="card-avatar">
                                    <a href="#pablo">
                                        <img class="img" src="../assets/img/sidebar-1.jpg" />
                                    </a>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-category">NGUYỄN PHƯƠNG ĐÔNG</h6>
                                    <h4 class="card-title">UDPM2</h4>
                                    <p class="card-description">
                                        Yêu màu tím và ghét sự giả dối
                                    </p>
                                    <a href="https://www.facebook.com/n.dongnobi/" class="btn btn-primary btn-round">Follow</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <nav class="float-left">
                        <ul>
                            <li>
                                <a href="https://www.facebook.com/n.dongnobi/">
                  ADMIN
                </a>
                            </li>
                    ...
                    <div class="copyright float-right" id="date">
                        ...
                        <a href="https://www.facebook.com/n.dongnobi/" target="_blank">DONG</a>
                    </div>
                </div>
            </footer>
            <script>

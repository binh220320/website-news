                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="row-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">View</label>
                                                    <input type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <span class="btn btn-default btn-file">Img<input class="input-file" accept="image/*" name="file" type="file" class="file" onchange="loadFile(event)">
                      </span>
